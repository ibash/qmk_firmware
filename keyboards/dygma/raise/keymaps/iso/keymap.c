...
[QWERTY] = LAYOUT_iso(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC,                                           KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, RGB_MOD, KC_RCTL,
...
// taken from kaleidoscope "led_map"
// Note that LEDS_PER_HAND isn't _actually_ the number of leds, but instead it's
// a split point
